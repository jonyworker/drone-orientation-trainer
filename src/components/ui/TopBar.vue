...
const emit = defineEmits(['toggle-pause', 'reset', 'toggle-help'])
</script>
...
<template>
  <header class="mb-3 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/10 bg-white/[0.035] px-4 py-3 backdrop-blur">
    <div>
      <p class="text-[11px] font-semibold uppercase tracking-[0.28em] text-lime-300/80">v0.2 Foundation · Third-person ATTI trainer</p>
